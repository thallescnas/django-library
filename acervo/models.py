...
class Tipo(models.Model):
    ...
    tipo = models.CharField(max_length=15, status=status, blank=False, null=False)
...
class Categoria(models.Model):
    ...
    categorias = models.CharField(max_length=200, status=status, null=False, blank=False)
class Livro(models.Model):
    ...
    tipo = models.ForeignKey(Tipo, blank=False, null=False, default="digital")